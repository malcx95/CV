...
\textbf{2019 -} & Pågående examensarbete vid Veoneer i Linköping, där
    körfältsestimering ska genomföras med deep learning. \\
...
Goda kunskaper inom C, C\#, C++, Java, Python, VHDL, Matlab, JavaScript och assembler.
Grundläggande kunskaper inom ASP.NET, HTML, Haskell, BASH-skript,
CoffeeScript, Ruby On Rails och Rust.
